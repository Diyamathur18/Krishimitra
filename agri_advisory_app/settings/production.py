"""
Production settings for Krishimitra AI deployment on Render
"""
...
ALLOWED_HOSTS = [
    ...
    '.herokuapp.com',  # Heroku domains (if needed)
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@krishimitra-ai.com')
...
GOVERNMENT_API_CACHE_TIMEOUT = 300
...
CSP_CONNECT_SRC = ("'self'", "https://api.ollama.ai")
