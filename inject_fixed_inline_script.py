...
# FIXED inline script - addressing all issues
inline_script = '''
    <!-- Complete Inline Service Loading Script - FIXED -->
    <script>
    (function() {
        ...
        let currentMandi = 'All Mandis'; // Track selected mandi
            ...
            try {
                ...
                if (schemes && schemes.length > 0) {
                    ...
                    schemes.forEach(scheme => {
                        // FIXED: Remove cursor pointer and hover effects to prevent clickability
                        html += `
...
print("✅ FIXED inline script injected!")
print("   ✓ Government schemes are NOT clickable (no cursor pointer)")
print("   ✓ Mandi selection WORKS (updates currentMandi and reloads)")
print("   ✓ Shows which mandi is selected (displays mandi name)")
print("   ✓ Selected mandi highlighted with checkmark and border")
