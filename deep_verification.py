...
class DeepServiceVerifier:
    ...
    def test_ai_assistant_deep(self):
        ...
        print("\n" + "="*80)
        print("🤖 DEEP AI ASSISTANT VERIFICATION")
        print("="*80)
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    if source_correct and content_correct and quality_good:
                        ...
                        print(f"   ⚠️  PARTIAL - Source: {data_source}, Content: {content_correct}, Quality: {quality_good}")
    ...
    def test_crop_recommendations_deep(self):
        ...
        print("\n" + "="*80)
        print("🌾 DEEP CROP RECOMMENDATIONS VERIFICATION")
        print("="*80)
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    if fields_present and has_recommendations and crop_data_complete:
                        ...
                        print(f"   ⚠️  PARTIAL - Fields: {fields_present}, Crops: {has_recommendations}, Complete: {crop_data_complete}")
    ...
    def test_government_schemes_deep(self):
        ...
        print("\n" + "="*80)
        print("🏛️ DEEP GOVERNMENT SCHEMES VERIFICATION")
        print("="*80)
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if total_schemes > 0 and scheme_data_quality:
                    ...
                    print(f"   ⚠️  PARTIAL - Schemes: {total_schemes}, Quality: {scheme_data_quality}")
    ...
    def test_weather_data_deep(self):
        ...
        print("\n" + "="*80)
        print("🌤️ DEEP WEATHER DATA VERIFICATION")
        print("="*80)
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if has_temperature and has_humidity and has_wind and has_location:
                    ...
                    print(f"   ⚠️  PARTIAL - Temp: {has_temperature}, Humidity: {has_humidity}, Wind: {has_wind}")
    ...
    def test_market_prices_deep(self):
        ...
        print("\n" + "="*80)
        print("💰 DEEP MARKET PRICES VERIFICATION")
        print("="*80)
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if has_crops and crop_data_complete:
                    ...
                    if crops:
                        sample_crop = crops[0]
                        print(f"   Sample: {sample_crop.get('name', 'Unknown')} - ₹{sample_crop.get('current_price', 'N/A')}/quintal")
                else:
                    print(f"   ⚠️  PARTIAL - Crops: {has_crops}, Complete: {crop_data_complete}")
    ...
    def test_location_services_deep(self):
        ...
        print("\n" + "="*80)
        print("📍 DEEP LOCATION SERVICES VERIFICATION")
        print("="*80)
        ...
        for query in search_queries:
            try:
                ...
                if response.status_code == 200:
                    ...
                    if suggestions:
                        print(f"   ✅ {query}: {len(suggestions)} suggestions found")
                        self.log_result("Location Search", query, "PASSED", f"{len(suggestions)} suggestions")
                    else:
                        print(f"   ⚠️  {query}: No suggestions")
    ...
    def test_pest_detection_deep(self):
        ...
        print("\n" + "="*80)
        print("🐛 DEEP PEST DETECTION VERIFICATION")
        print("="*80)
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    if has_pests and has_prevention and has_treatment:
                        ...
                        print(f"   ⚠️  PARTIAL - Pests: {has_pests}, Prevention: {has_prevention}, Treatment: {has_treatment}")
    ...
    def test_frontend_deep(self):
        ...
        print("\n" + "="*80)
        print("🖥️  DEEP FRONTEND VERIFICATION")
        print("="*80)
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if passed_checks >= total_checks * 0.8:  # 80% pass rate
                    ...
                    print(f"\n   ⚠️  FRONTEND PARTIAL - {passed_checks}/{total_checks} checks passed")
    ...
    def generate_comprehensive_report(self):
        ...
        print(f"   ⚠️  Partial: {partial_tests} ({partial_rate:.1f}%)")
        ...
        print(f"\n⏱️  Test Duration: {duration.total_seconds():.1f} seconds")
...
if __name__ == "__main__":
    ...
    if results['success_rate'] >= 80:
        ...
        print(f"⚠️  ATTENTION: {results['failed_tests']} tests failed, {results['partial_tests']} partial")
